  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img 
          src="/assets/illustrations/access_denied-w1280.png" 
          alt="Access denied background" 
          className="w-full h-full object-cover"
        />
        {/* Dark overlay for better contrast */}
        <div className="absolute inset-0 bg-gradient-to-br from-neutral-900/60 via-neutral-800/50 to-transparent"></div>
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div className="flex items-center">
            <div className="w-full max-w-md">
              <div className="bg-white/95 backdrop-blur-md rounded-3xl p-8 md:p-10 shadow-2xl border border-white/50">
                {/* Header */}
