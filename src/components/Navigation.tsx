        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="hidden lg:flex items-center gap-6">
            ...
            {authState.isAuthenticated && (
              <a href="/dashboard" className={`text-sm font-medium transition-colors ${needsDarkText ? 'text-neutral-600 hover:text-neutral-900' : 'text-white/90 hover:text-white'}`}>Dashboard</a>
            )}
          ...
          <div className="hidden lg:flex items-center gap-4">
            {authState.isAuthenticated && authState.user ? (
              <>
                ...
                <a href="/projects/new" className="px-4 py-2 bg-primary-500 hover:bg-accent-500 text-white text-sm font-semibold rounded-lg transition-colors duration-300">
                  Nouveau projet
                </a>
              ...
              <>
                ...
                <a href="/register" className="px-4 py-2 bg-primary-500 hover:bg-accent-500 text-white text-sm font-semibold rounded-lg transition-colors duration-300">
                  S'inscrire
                </a>
              </>
            )}
    ...
    <div className={`fixed top-0 right-0 h-full w-80 max-w-[85vw] bg-white backdrop-blur-sm shadow-2xl z-50 lg:hidden transition-all duration-300 ease-out transform ${
      ...
      <div className="overflow-y-auto h-[calc(100%-80px)]">
        <div className="p-6 space-y-1">
          ...
          {authState.isAuthenticated && (
            <a href="/dashboard" className="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-neutral-100 transition-all duration-300 group">
              <svg className="w-5 h-5 text-neutral-600 group-hover:text-primary-600 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" />
              </svg>
              <span className="text-neutral-700 font-medium group-hover:text-primary-600 transition-colors">Dashboard</span>
            </a>
          )}
          ...
          {authState.isAuthenticated && authState.user ? (
            <>
              <a href="/projects/new" className="flex items-center justify-center gap-2 px-6 py-3.5 bg-primary-500 hover:bg-accent-500 text-white rounded-xl font-bold shadow-lg hover:shadow-xl transform hover:scale-[1.02] transition-all duration-300">
              ...
              <div className="pt-4 space-y-1">
                ...
                <a href={`/profile/${authState.user.username}`} className="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-neutral-100 transition-all duration-300 group">
                  <svg className="w-5 h-5 text-neutral-600 group-hover:text-primary-600 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="/settings" className="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-neutral-100 transition-all duration-300 group">
                  <svg className="w-5 h-5 text-neutral-600 group-hover:text-primary-600 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <>
              <a href="/login" className="flex items-center justify-center gap-2 px-6 py-3.5 border border-neutral-300 text-neutral-700 rounded-xl font-bold hover:bg-neutral-50 transition-all duration-300">
                Connexion
              </a>
              
              <a href="/register" className="flex items-center justify-center gap-2 px-6 py-3.5 bg-primary-500 hover:bg-accent-500 text-white rounded-xl font-bold shadow-lg hover:shadow-xl transform hover:scale-[1.02] transition-all duration-300">
